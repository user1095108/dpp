...
You can use decimal floating-point types this library provides with [STL](https://en.wikipedia.org/wiki/C%2B%2B_Standard_Library) implementations of elementary math functions (`std::sin()`, `std::sqrt()`, ...).
# build instructions
