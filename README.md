...
The underlying design goal was to extract as many **decimal** digits as possible out of the **int32_t**/**int64_t** combo, with an eye towards the **int64_t**/**int128_t** combo. Hopefully at tolerable performance and binary size.
# build instructions
