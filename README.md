...
The underlying idea was to extract as many **decimal** digits out of the **int32_t**/**int64_t** combo as possible, with an eye towards the emerging **int64_t**/**int128_t** combo. Hopefully at tolerable performance and binary size.
# build instructions
