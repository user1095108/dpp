...
The underlying design goal was maximize the number of extractable **decimal** digits of the **`int32_t`**/**`int64_t`** pair, with an eye towards the **`int64_t`**/**`int128_t`** pair. Hopefully at tolerable performance and binary sizes.
# build instructions
