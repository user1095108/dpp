...
int main()
{
  ...
  std::cout << std::hex << std::uint64_t(igr * dpp::detail::pow<dpp::d256, 2>(64)) << std::endl;
  std::cout << std::hex << intt::intt<std::uint64_t, 3>(igr * dpp::detail::pow<dpp::d256, 2>(128)) << std::endl;
